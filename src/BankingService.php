...
class BankingService extends BaseService
{
    ...
    public function getSubmissionCheque($params) {
        ...
        $dataForSign = [
            ...
            "MinAmount" => isset($params["MinAmount"]) ? (string)$params["MinAmount"] : '',
            "MaxAmount" => isset($params["MaxAmount"]) ? (string)$params["MaxAmount"] : '',
            "StartDate" => isset($params["StartDate"]) ? $params["StartDate"] : '',
            "EndDate" =>  isset($params["EndDate"]) ? $params["EndDate"] : '',
            "BankCode" => isset($params["BankCode"]) ? (string)$params["BankCode"] : '',
            "ChequeStatus" => isset($params["ChequeStatus"]) ? (string)$params["ChequeStatus"] : '',
            "StartSubmisionDate" => isset($params["StartSubmisionDate"]) ? $params["StartSubmisionDate"] : '',
            "EndSubmissionDate" => isset($params["EndSubmissionDate"]) ? $params["EndSubmissionDate"] : '',
